...
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 USE_UPNP=- -o Makefile Ganjacoin-qt.pro
#############################################################################
...
DISTDIR = /home/alex/Desktop/newwallettest/build/ganjacoin-qt1.0.7
LINK          = g++
...
Makefile: Ganjacoin-qt.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-g++-64 USE_UPNP=- -o Makefile Ganjacoin-qt.pro
